...
+ (NSString *)systemPrompt
{
    ...
    if ([self isCodeOnly]) {
        return @"You are a LaTeX code completion assistant. "
               ...
               @"Do NOT complete or suggest natural language prose, sentence text, or paragraph content. "
               @"If the cursor is in a prose context with no LaTeX syntax to complete, return nothing. "
